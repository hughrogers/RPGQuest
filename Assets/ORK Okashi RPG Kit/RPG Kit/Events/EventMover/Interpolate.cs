...
public class Interpolate
{
	 ...
	 * var Function ease; // easing of a particular EaseType
	 * function Awake() {
	 ...
	 * elapsed.
	 */
	/*public static IEnumerator NewEase(Function ease, Vector3 start,
	                        Vector3 end, float duration) {
	 ...
	 */
	/*public static IEnumerator NewEase(Function ease, Vector3 start, Vector3 end,
	                        float total, IEnumerator driver) {
	 ...
	 */
	/*public static IEnumerator NewBezier(Function ease, Transform[] nodes,
	                          float duration) {
	  var timer = NewTimer(duration);
	 ...
	 */
	/*public static IEnumerator NewBezier(Function ease, Vector3[] points,
	                          float duration) {
	  var timer = NewTimer(duration);
	 ...
	 * slice variants. Normally you would not use this function directly.
	 */
	/*public static IEnumerator NewBezier(Function ease, IList nodes, Function toVector3,
	                          float maxStep, IEnumerator steps) {
	 ...
	 */
	/*public static Vector3 Bezier(Function ease, Vector3[] points,
	                        float elapsedTime, float duration) {
	 ...
	 * using Catmull-Rom.
	 */
	/*public static IEnumerator NewCatmullRom(Transform[] nodes, int slices,
	                              bool loop) {
	 ...
	 */
	/*public static IEnumerator NewCatmullRom(Vector3[] points, int slices,
	                              bool loop) {
	 ...
	 * function directly.
	 */
	/*public static IEnumerator NewCatmullRom(IList nodes, Function toVector3,
	                              int slices, bool loop) {
	  // need at least two nodes to spline between
	  if (nodes.Count >= 2) {
	 ...
	 */
	/*public static Vector3 CatmullRom(Vector3 previous, Vector3 start, Vector3 end, 
							   Vector3 next, float elapsedTime,
	                           float duration) {
	  // References used:
	  // p.266 GemsV1
	  //
